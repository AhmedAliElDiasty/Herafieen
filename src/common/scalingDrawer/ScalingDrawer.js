  ...
  animationInterpolate() {
    return this.state.isOpen ?
    {
      translateX: this.drawerAnimation.interpolate({
        inputRange: [0, 1],
        outputRange: this.props.rtl?[this.translateX, -this.maxTranslateXValue]:[this.translateX, this.maxTranslateXValue],
        extrapolate: 'clamp'
      }),
      ...
      :
    {
      translateX: this.drawerAnimation.interpolate({
        inputRange: [0, 1],
        outputRange: this.props.rtl?[-this.translateX, 0]:[this.translateX, 0],
        extrapolate: 'clamp'
      }),
      scale: this.drawerAnimation.interpolate({
        inputRange: [0, 1],

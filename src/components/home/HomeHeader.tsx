...
export const HomeHeader: NavigationFunctionComponent<Props> = (props: Props) => {
  return (
    <View style={styles.headerContainer}>     
      ...
      <AppText style={styles.headerContent}>Home</AppText>
      </View>  
      <AppIcon name='search' color={rootStore.getState().theme.colors.primary} size={30} type={IconType.ionicons} onPress={() => props.drawerRef.current.open()} />
      </View>
